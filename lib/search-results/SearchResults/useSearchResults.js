...
function useSearchResults(props) {
  ...
  const [term, setTerm] = (0, _react.useState)(defaultSerchParams.get(searchQueryKey));
  const [sort, setSort] = (0, _react.useState)(defaultSerchParams.get(sortQueryKey) || sortOptions[0].value);
