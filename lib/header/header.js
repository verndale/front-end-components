...
class Header extends _core.Component {
  ...
  handleItemActive(e) {
    var _this$dom$$activePage2;

    (_this$dom$$activePage2 = this.dom.$activePage) === null || _this$dom$$activePage2 === void 0 ? void 0 : _this$dom$$activePage2.classList.remove('header__item--active');
